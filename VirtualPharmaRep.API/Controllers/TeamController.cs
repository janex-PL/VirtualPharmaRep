...
namespace VirtualPharmaRep.API.Controllers
{
    ...
    public class TeamController : BaseApiCrudController<Team, TeamViewModel, TeamDto, TeamEntityValidator,
        TeamCrudService>
    {
        public TeamController(TeamCrudService crudService, IPermissionResolverService permissionResolverService) : base(crudService, permissionResolverService)
        {
        }
    }
}
